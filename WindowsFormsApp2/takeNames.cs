...
{
    public partial class takeNames : Form
    {
        ...
        private void addName_Click(object sender, EventArgs e)
        {
            ...
            {
                nameError.Text = "Please fill out full name";
            }
            else
            {
                string firstName = first.Text.ToLower();
                firstName = firstName.First().ToString().ToUpper() + String.Join("", firstName.Skip(1));
                string lastName = last.Text.ToLower();
        ...
        public string convertGrade(decimal x)
        {
            string y = "";
